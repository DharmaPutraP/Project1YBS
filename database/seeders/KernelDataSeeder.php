...
class KernelDataSeeder extends Seeder
{
    public function run(): void
    {
        $data = [
            ...
            // ── Inlet Kernel Silo ──────────────────────────────────────────────
            ['kode' => 'IN1',  'nama_sample' => 'INLET KERNEL SILO 1',           'limit_operator' => 'le', 'limit_value' => 7.000],
            ['kode' => 'IN2',  'nama_sample' => 'INLET KERNEL SILO 2',           'limit_operator' => 'le', 'limit_value' => 7.000],
            ['kode' => 'IN3',  'nama_sample' => 'INLET KERNEL SILO 3',           'limit_operator' => 'le', 'limit_value' => 7.000],
            ['kode' => 'IN4',  'nama_sample' => 'INLET KERNEL SILO 4',           'limit_operator' => 'le', 'limit_value' => 7.000],
