    ...
    public function run(): void
    {
        $officeMasterData = [
            ...
            'SUN' => [
                ...
                // HEAVY PHASE (HP1-3)
                // ═══════════════════════════════════════════════════════════════════
                ['kode' => 'HP1', 'column_name' => 'HEAVY PHASE 1 GEA', 'jenis' => 'HEAVY PHASE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'HEAVY PHASE 1', 'limit_operator' => 'le', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Heavy Phase 1 Gea', 'is_active' => true],
                ['kode' => 'HP2', 'column_name' => 'HEAVY PHASE 2 GEA', 'jenis' => 'HEAVY PHASE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'HEAVY PHASE 2', 'limit_operator' => 'le', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Heavy Phase 2 Gea', 'is_active' => true],
                ['kode' => 'HP3', 'column_name' => 'HEAVY PHASE 3 GEA', 'jenis' => 'HEAVY PHASE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'HEAVY PHASE 3', 'limit_operator' => 'le', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Heavy Phase 3 Gea', 'is_active' => true],

                // ═══════════════════════════════════════════════════════════════════
                // SOLID DECANTER (SD1-2)
                // ═══════════════════════════════════════════════════════════════════
                ['kode' => 'SD1', 'column_name' => 'SOLID DECANTER 1 GEA', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 1', 'limit_operator' => 'le', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid Decanter 1 Gea', 'is_active' => true],
                ['kode' => 'SD2', 'column_name' => 'SOLID DECANTER 2 GEA', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 2', 'limit_operator' => 'le', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid Decanter 2 Gea', 'is_active' => true],
                ...
                ['kode' => 'SP1', 'column_name' => 'SLUDGE SEPARATOR 1', 'jenis' => 'SLUDGE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'SLUDGE SEPARATOR 1', 'limit_operator' => 'lt', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Sludge Separator 1', 'is_active' => true],
                ['kode' => 'SP2', 'column_name' => 'SLUDGE SEPARATOR 2', 'jenis' => 'SLUDGE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'SLUDGE SEPARATOR 2', 'limit_operator' => 'lt', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Sludge Separator 2', 'is_active' => true],
                ['kode' => 'SP3', 'column_name' => 'SLUDGE SEPARATOR 3', 'jenis' => 'SLUDGE', 'persen' => 0, 'persen4' => 0, 'pivot' => 'SLUDGE SEPARATOR 3', 'limit_operator' => 'lt', 'limitOLWB' => 1.00, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Sludge Separator 3', 'is_active' => true],
                // ['kode' => 'JK1', 'column_name' => 'JANJANGAN KOSONG 1', 'jenis' => 'JANJANGAN', 'persen' => 0, 'persen4' => 0, 'pivot' => '', 'limitOLWB' => null, 'limitOLDB' => null, 'limitOL' => null, 'description' => 'Janjangan Kosong 1', 'is_active' => true],
        ...
        // Use YBS baseline when SUN/SJN rows are not explicitly defined yet.
        foreach (['SUN', 'SJN'] as $office) {
            if (empty($officeMasterData[$office])) {
                $officeMasterData[$office] = $officeMasterData['YBS'];
            }
        }

        $masterData = [];
        foreach ($officeMasterData as $office => $rows) {
            foreach ($rows as $data) {
                $masterData[] = array_merge($data, [
                    'office' => $office,
                    'limit_operator' => $data['limit_operator'] ?? 'le',
                ]);
            }
        }
        ...
        foreach ($masterData as $data) {
            OilMasterData::updateOrCreate(
                ['office' => $data['office'], 'kode' => $data['kode']],
                $data
            );
        }
