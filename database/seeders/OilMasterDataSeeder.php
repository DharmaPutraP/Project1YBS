...
class OilMasterDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $masterData = [
            ...
            // FEED DECANTER (FD1-4)
            // ═══════════════════════════════════════════════════════════════════
            ['kode' => 'FD1', 'column_name' => 'FEED DECANTER ALVA LAFAL 1', 'jenis' => 'FEED DECANTER', 'persen' => 0, 'persen4' => 0, 'pivot' => 'FEED 1', 'limitOLWB' => 6.00, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Feed Decanter Alfa Laval 1', 'is_active' => true],
            ...
            // ═══════════════════════════════════════════════════════════════════
            ['kode' => 'SD1', 'column_name' => 'SOLID ALFA LAVAL 1', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 1', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid Alfa Laval 1, persen 0.02 = 2%', 'is_active' => true],
            ['kode' => 'SD2', 'column_name' => 'SOLID IHI', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 2', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid IHI, persen 0.02 = 2%', 'is_active' => true],
            ['kode' => 'SD3', 'column_name' => 'SOLID ALFA LAVAL 2', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 3', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid Alfa Laval 2, persen 0.02 = 2%', 'is_active' => true],
            ['kode' => 'SD4', 'column_name' => 'SOLID FLOTTWEG', 'jenis' => 'SOLID', 'persen' => 0.02, 'persen4' => 0, 'pivot' => 'SOLID 4', 'limitOLWB' => 2.50, 'limitOLDB' => null, 'limitOL' => 0.09, 'description' => 'Solid Flottweg, persen 0.02 = 2%', 'is_active' => true],
            ...
            // ═══════════════════════════════════════════════════════════════════
            ['kode' => 'FBP1', 'column_name' => 'FIBRE EX BUNCH PRESS 1', 'jenis' => 'BUNCH PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'BUNCH PRESS 1', 'limitOLWB' => 1.30, 'limitOLDB' => null, 'limitOL' => 0.75, 'description' => 'Fibre Ex Bunch Press 1, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FBP2', 'column_name' => 'FIBRE EX BUNCH PRESS 2', 'jenis' => 'BUNCH PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'BUNCH PRESS 2', 'limitOLWB' => 1.30, 'limitOLDB' => null, 'limitOL' => 0.75, 'description' => 'Fibre Ex Bunch Press 2, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FBP3', 'column_name' => 'FIBRE EX BUNCH PRESS 3', 'jenis' => 'BUNCH PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'BUNCH PRESS 3', 'limitOLWB' => 1.30, 'limitOLDB' => null, 'limitOL' => 0.75, 'description' => 'Fibre Ex Bunch Press 3, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FBP4', 'column_name' => 'FIBRE EX BUNCH PRESS 4', 'jenis' => 'BUNCH PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'BUNCH PRESS 4', 'limitOLWB' => 1.30, 'limitOLDB' => null, 'limitOL' => 0.75, 'description' => 'Fibre Ex Bunch Press 4, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FBP5', 'column_name' => 'FIBRE EX BUNCH PRESS 5', 'jenis' => 'BUNCH PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'BUNCH PRESS 5', 'limitOLWB' => 1.30, 'limitOLDB' => null, 'limitOL' => 0.20, 'description' => 'Fibre Ex Bunch Press 5, persen 0.13 = 13%, OIL LOSSES ≤ 0.2', 'is_active' => true],

            // ═══════════════════════════════════════════════════════════════════
            // FIBRE PRESS (FP1-9)
            // ═══════════════════════════════════════════════════════════════════
            ['kode' => 'FP1', 'column_name' => 'FIBRE PRESS 1', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 1', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 1, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP2', 'column_name' => 'FIBRE PRESS 2', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 2', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 2, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP3', 'column_name' => 'FIBRE PRESS 3', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 3', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 3, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP4', 'column_name' => 'FIBRE PRESS 4', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 4', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 4, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP5', 'column_name' => 'FIBRE PRESS 5', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 5', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 5, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP6', 'column_name' => 'FIBRE PRESS 6', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 6', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 6, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP7', 'column_name' => 'FIBRE PRESS 7', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 7', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 7, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP8', 'column_name' => 'FIBRE PRESS 8', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 8', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 8, persen 0.13 = 13%', 'is_active' => true],
            ['kode' => 'FP9', 'column_name' => 'FIBRE PRESS 9', 'jenis' => 'PRESS', 'persen' => 0.13, 'persen4' => 0, 'pivot' => 'PRESS 9', 'limitOLWB' => 3.80, 'limitOLDB' => 7.50, 'limitOL' => 0.50, 'description' => 'Fibre Press 9, persen 0.13 = 13%', 'is_active' => true],
        ];
