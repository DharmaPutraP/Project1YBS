    ...
    <div class="container mx-auto flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:gap-2">
                ...
                <span class="text-xs sm:text-sm opacity-90 hidden sm:inline">| Data akan disimpan sementara</span>
            </div>
        </div>
        ...
        <div class="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            ...
            <button type="button" id="sync-pending-btn" onclick="window.offlineManager.syncPending()"
                class="bg-white text-yellow-600 hover:bg-yellow-50 px-3 py-1 rounded font-semibold text-xs sm:text-sm transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-1">
