                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.0001" name="nut_utuh_nut" id="nut_utuh_nut"
                            value="{{ old('nut_utuh_nut') }}" placeholder="0.0000"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
                    ...
                    <div>
                        ...
                        <input type="number" step="0.0001" name="nut_utuh_kernel" id="nut_utuh_kernel"
                            value="{{ old('nut_utuh_kernel') }}" placeholder="0.0000"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" step="0.0001" name="nut_pecah_nut" id="nut_pecah_nut"
                            value="{{ old('nut_pecah_nut') }}" placeholder="0.0000"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
                    ...
                    <div>
                        ...
                        <input type="number" step="0.0001" name="nut_pecah_kernel" id="nut_pecah_kernel"
                            value="{{ old('nut_pecah_kernel') }}" placeholder="0.0000"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.0001" name="kernel_utuh" id="kernel_utuh"
                        value="{{ old('kernel_utuh') }}" placeholder="0.0000"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
                ...
                <div>
                    ...
                    <input type="number" step="0.0001" name="kernel_pecah" id="kernel_pecah"
                        value="{{ old('kernel_pecah') }}" placeholder="0.0000"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-indigo-500
