            ...
            <table class="min-w-[1700px] text-xs text-gray-700 divide-y divide-gray-200">
                <thead class="bg-blue-50 sticky top-0 z-40">
                    <tr>
                        ...
                        <th class="sticky top-0 z-20 bg-purple-100 border px-3 py-3 text-purple-700">SAMPLE NUT UTUH (%)
                        </th>
                        <th class="sticky top-0 z-20 bg-purple-100 border px-3 py-3 text-purple-700">SAMPLE NUT PECAH
                            (%)</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @empty
                        <tr>
                            <td colspan="17" class="px-4 py-16 text-center text-sm text-gray-400">Belum ada data laporan
