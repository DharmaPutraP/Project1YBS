<x-layouts.app title="Laporan Ripple Mill">
    ...
    <x-ui.card title="Tabel Data Laporan Ripple Mill">
        ...
        <div class="relative overflow-x-auto overflow-y-auto max-h-[600px] border rounded-lg">
            <table class="min-w-[1700px] text-xs text-gray-700 divide-y divide-gray-200">
                <thead class="bg-blue-50 sticky top-0 z-40">
                    <tr>
                        ...
                        <th class="sticky top-0 z-20 bg-purple-100 border px-3 py-3 text-purple-700">SAMPLE NUT UTUH (%)</th>
                        <th class="sticky top-0 z-20 bg-purple-100 border px-3 py-3 text-purple-700">SAMPLE NUT PECAH (%)</th>
                        <th class="sticky top-0 z-20 bg-red-50 border px-3 py-3 text-red-700">EFFICIENCY (%)</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($rows as $row)
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border px-3 py-2 text-center bg-red-50">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold {{ $isGood === null ? 'bg-gray-100 text-gray-700' : ($isGood ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800') }}">
                    ...
                    @empty
                        <tr>
                            <td colspan="17" class="px-4 py-16 text-center text-sm text-gray-400">Belum ada data laporan Ripple Mill untuk periode ini.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
