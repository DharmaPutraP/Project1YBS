        ...
        <form action="{{ route('kernel.qwt.store') }}" method="POST" id="kernelQwtForm" class="space-y-5"
            ...
            <div class="mt-6 border-2 border-blue-200 bg-blue-50 rounded-lg p-5">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div>
                        <label for="sampel_setelah_kuarter" class="block text-sm font-medium text-gray-700 mb-2">Sampel Setelah Kuarter <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="sampel_setelah_kuarter" id="sampel_setelah_kuarter" value="{{ old('sampel_setelah_kuarter') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('sampel_setelah_kuarter') border-red-400 bg-red-50 @enderror">
                    ...
                    <div>
                        <label for="berat_kernel_utuh" class="block text-sm font-medium text-gray-700 mb-2">Berat Kernel Utuh <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="berat_kernel_utuh" id="berat_kernel_utuh" value="{{ old('berat_kernel_utuh') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('berat_kernel_utuh') border-red-400 bg-red-50 @enderror">
                        @error('berat_kernel_utuh')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="berat_kernel_pecah" class="block text-sm font-medium text-gray-700 mb-2">Berat Kernel Pecah <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="berat_kernel_pecah" id="berat_kernel_pecah" value="{{ old('berat_kernel_pecah') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('berat_kernel_pecah') border-red-400 bg-red-50 @enderror">
                        @error('berat_kernel_pecah')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="berat_cangkang" class="block text-sm font-medium text-gray-700 mb-2">Berat Cangkang <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="berat_cangkang" id="berat_cangkang" value="{{ old('berat_cangkang') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('berat_cangkang') border-red-400 bg-red-50 @enderror">
                        @error('berat_cangkang')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="berat_batu" class="block text-sm font-medium text-gray-700 mb-2">Berat Batu <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="berat_batu" id="berat_batu" value="{{ old('berat_batu') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('berat_batu') border-red-400 bg-red-50 @enderror">
                        @error('berat_batu')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="moisture" class="block text-sm font-medium text-gray-700 mb-2">Moisture <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="moisture" id="moisture" value="{{ old('moisture') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('moisture') border-red-400 bg-red-50 @enderror">
                        @error('moisture')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="ampere_screw" class="block text-sm font-medium text-gray-700 mb-2">Ampere Screw <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="ampere_screw" id="ampere_screw" value="{{ old('ampere_screw') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('ampere_screw') border-red-400 bg-red-50 @enderror">
                        @error('ampere_screw')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="tekanan_hydraulic" class="block text-sm font-medium text-gray-700 mb-2">Tekanan Hydraulic <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="tekanan_hydraulic" id="tekanan_hydraulic" value="{{ old('tekanan_hydraulic') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('tekanan_hydraulic') border-red-400 bg-red-50 @enderror">
                        @error('tekanan_hydraulic')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
                    </div>

                    <div>
                        <label for="kecepatan_screw" class="block text-sm font-medium text-gray-700 mb-2">Kecepatan Screw <span class="text-red-500">*</span></label>
                        <input type="number" step="0.0001" name="kecepatan_screw" id="kecepatan_screw" value="{{ old('kecepatan_screw') }}" placeholder="0.0000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 @error('kecepatan_screw') border-red-400 bg-red-50 @enderror">
