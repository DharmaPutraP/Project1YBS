                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        @foreach($group['items'] as $item)
                            ...
                            <div class="border border-amber-200 rounded-lg p-4 bg-white/85 shadow-sm space-y-3">
                                ...
                                <div class="space-y-3">
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Sampel Setelah Kuarter</label>
                                        <input type="number" step="0.0001" name="rows[{{ $kode }}][sampel_setelah_kuarter]" value="{{ old("rows.$kode.sampel_setelah_kuarter") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                    </div>

                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 mb-1">Berat Nut Utuh</label>
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_nut_utuh]" value="{{ old("rows.$kode.berat_nut_utuh") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 mb-1">Berat Nut Pecah</label>
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_nut_pecah]" value="{{ old("rows.$kode.berat_nut_pecah") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 mb-1">Berat Kernel Utuh</label>
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_kernel_utuh]" value="{{ old("rows.$kode.berat_kernel_utuh") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 mb-1">Berat Kernel Pecah</label>
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_kernel_pecah]" value="{{ old("rows.$kode.berat_kernel_pecah") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_cangkang]" value="{{ old("rows.$kode.berat_cangkang") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                        <div>
                                            <label class="block text-xs font-medium text-gray-700 mb-1">Berat Batu</label>
                                            <input type="number" step="0.0001" name="rows[{{ $kode }}][berat_batu]" value="{{ old("rows.$kode.berat_batu") }}" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm">
                                        </div>
                                    </div>
