<x-layouts.app title="Rekap Data Kernel Losses">
    ...
    <div class="mb-6">
        ...
        <p class="mt-2 text-sm text-gray-600">Rata-rata kernel losses per kode per hari. Merah = melebihi limit, Hijau =
            sesuai limit.</p>
    </div>
                ...
                <div class="overflow-x-auto border rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 border border-gray-300 text-xs">
                        <thead>
                            ...
                            <tr>
                                <th rowspan="2"
                                    class="px-4 py-3 text-left text-xs font-bold text-gray-700 uppercase tracking-wider border-r border-b border-gray-300 sticky left-0 bg-indigo-50 z-10 min-w-[110px]">
                                    Tanggal
                                </th>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    @foreach($columnGroups as $group)
                                        @foreach($group['columns'] as $cIdx => $col)
                                            ...
                                            @endphp
                                            <td
                                                class="px-2 py-2 text-center border-r border-gray-300 {{ $cIdx === 0 ? 'border-l-2 border-l-gray-400' : '' }}">
                                                @if($cell !== null)
                                                    @php
