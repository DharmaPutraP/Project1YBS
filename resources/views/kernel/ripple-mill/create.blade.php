        ...
        <form action="{{ route('kernel.ripple-mill.store') }}" method="POST" id="rippleMillForm" class="space-y-5"
            ...
            <div class="mt-6 border-2 border-blue-200 bg-blue-50 rounded-lg p-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="berat_sampel" class="block text-sm font-medium text-gray-700 mb-2">Berat Sample
            ...
            <div class="mt-4">
                ...
                @error('pengulangan')<p class="mt-1 text-xs text-red-600">{{ $message }}</p>@enderror
            </div>
            ...
            <div class="flex flex-wrap justify-end gap-3 pt-6 border-t border-gray-200">
                ...
                <button type="submit" onclick="document.getElementById('formAction').value='save_and_add'"
                    class="px-5 py-2.5 border border-indigo-300 text-indigo-700 rounded-lg hover:bg-indigo-50 transition font-medium">Simpan
                    &amp; Tambah Lagi</button>
