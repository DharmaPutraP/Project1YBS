<x-layouts.app title="Edit Analisa Spintest Light Phase">
    <div class="mx-auto max-w-3xl space-y-6">
        <x-ui.card title="Edit Analisa Spintest Light Phase">
            <form action="{{ route('analisa-moisture.spintest-light-phase.update', $row) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end gap-3 border-t border-gray-200 pt-4">
                    <a href="{{ route('analisa-moisture.spintest-light-phase') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700">Batal</a>
