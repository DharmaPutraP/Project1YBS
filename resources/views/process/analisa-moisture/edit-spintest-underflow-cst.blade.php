<x-layouts.app title="Edit Analisa Spintest Underflow CST">
    <div class="mx-auto max-w-3xl space-y-6">
        <x-ui.card title="Edit Analisa Spintest Underflow CST">
            <form action="{{ route('analisa-moisture.spintest-underflow-cst.update', $row) }}" method="POST" class="space-y-4">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end gap-3 border-t border-gray-200 pt-4">
                    <a href="{{ route('analisa-moisture.spintest-underflow-cst') }}" class="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700">Batal</a>
