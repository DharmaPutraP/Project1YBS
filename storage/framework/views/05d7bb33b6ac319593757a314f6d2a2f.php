...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Input Data Oil Losses Oil Losses']); ?>
        <form action="<?php echo e(route('oil.store')); ?>" method="POST" id="labForm" class="space-y-6">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisValue => $jenisLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jenisValue); ?>" <?php echo e(old('jenis') == $jenisValue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="operator" id="operator" value="<?php echo e(old('operator')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="sampel_boy" id="sampel_boy" value="<?php echo e(old('sampel_boy')); ?>"
                    ...
                    <!-- <div>
                        ...
                        <textarea name="parameter_lain" id="parameter_lain" rows="2"
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-blue-500
                                   <?php $__errorArgs = ['parameter_lain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('parameter_lain')); ?></textarea>
                        <?php $__errorArgs = ['parameter_lain'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
