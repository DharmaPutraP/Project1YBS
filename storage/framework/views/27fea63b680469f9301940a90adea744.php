                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $calculations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-200">
                            ...
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->cawan_kosong === null ? '-' : number_format($calc->cawan_kosong, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->berat_basah === null ? '-' : number_format($calc->berat_basah, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->total_cawan_basah === null ? '-' : number_format($calc->total_cawan_basah, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->cawan_sample_kering === null ? '-' : number_format($calc->cawan_sample_kering, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->sampel_setelah_oven === null ? '-' : number_format($calc->sampel_setelah_oven, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->labu_kosong === null ? '-' : number_format($calc->labu_kosong, 4)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->oil_labu === null ? '-' : number_format($calc->oil_labu, 4)); ?>

                            </td>

                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->minyak === null ? '-' : number_format($calc->minyak, 4)); ?>

                            </td>

                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->moist === null ? '-' : number_format($calc->moist, 2)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->dmwm === null ? '-' : number_format($calc->dmwm, 2)); ?>
                            ...
                            <td class="border px-4 py-2 text-right">
                                ...
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php echo e($calc->olwb === null ? '-' : number_format($calc->olwb, 2)); ?>

                                </span>
                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->limitOLWB === null || $calc->limitOLWB == 0 ? '-' : number_format($calc->limitOLWB, 2)); ?>
                            ...
                            ?>
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php echo e($calc->oldb === null ? '-' : number_format($calc->oldb, 2)); ?>

                                </span>
                            </td>
                            <td class="border px-4 py-2 text-right">

                                <?php echo e($calc->limitOLDB === null || $calc->limitOLDB == 0 ? '-' : number_format($calc->limitOLDB, 2)); ?>
                            ...
                            <td class="border px-4 py-2 text-right">
                                ...
                                <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <?php echo e($calc->oil_losses === null ? '-' : number_format($calc->oil_losses, 2)); ?>

                                </span>
                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->limitOL === null || $calc->limitOL == 0 ? '-' : number_format($calc->limitOL, 2)); ?>

                            </td>
                            <td class="border px-4 py-2 text-right">
                                <?php echo e($calc->persen4 === null || $calc->persen4 == 0 ? '-' : number_format($calc->persen4, 2)); ?>
