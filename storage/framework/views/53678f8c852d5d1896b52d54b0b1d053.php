                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php $__currentLoopData = $kernelCalculations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $calc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="hover:bg-blue-50">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap text-center">
                                            <span
                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold <?php echo e(($calc->kegiatan_dispek ?? false) ? 'bg-amber-100 text-amber-800' : 'bg-gray-100 text-gray-700'); ?>">
                                                <?php echo e(($calc->kegiatan_dispek ?? false) ? 'Ya' : 'Tidak'); ?>
...
<?php endif; ?><?php /**PATH D:\ybs\Project1YBS\resources\views/kernel/index.blade.php ENDPATH**/ ?>