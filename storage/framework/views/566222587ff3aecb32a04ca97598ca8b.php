    ...
    <div class="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
            <p class="text-sm font-semibold text-emerald-900">
                <?php echo e($successProof['message'] ?? 'Data berhasil disimpan.'); ?>

            </p>
            <p class="mt-1 text-sm text-emerald-800">Waktu bukti dibuat: <?php echo e($successProof['generated_at'] ?? '-'); ?></p>
...
<section class="mb-6 rounded-xl border border-blue-200 bg-blue-50/60 p-4">
    <div class="mb-3 flex items-center justify-between">
        <h3 class="text-lg font-semibold text-slate-900">Ringkasan Input <?php echo e($moduleLabel); ?></h3>
    </div>
        ...
        <table class="min-w-full divide-y divide-blue-200 overflow-hidden rounded-lg bg-white">
            ...
            <tbody class="divide-y divide-blue-100 text-sm text-slate-700">
                <?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['tanggal_input'] ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['jam_proses'] ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap font-semibold text-blue-900">
                            <?php echo e($entry['kode_label'] ?? ($entry['kode'] ?? '-')); ?>

                        </td>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['jenis'] ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['operator'] ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['sampel_boy'] ?? '-'); ?></td>
                        <td class="px-4 py-3 whitespace-nowrap"><?php echo e($entry['input_by'] ?? '-'); ?></td>
                    </tr>
...
<?php if(!empty($entriesMetrics)): ?>
    <section class="mb-6 rounded-xl border border-purple-200 bg-purple-50/60 p-4">
        ...
        <?php $__currentLoopData = $entriesMetrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entryMetric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <div class="mb-4 overflow-x-auto">
                ...
                <table class="min-w-full divide-y divide-purple-200 overflow-hidden rounded-lg bg-white">
                    ...
                    <tbody class="divide-y divide-purple-100 text-sm text-slate-700">
                        <?php $__currentLoopData = $entryMetricsRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            ?>
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap"><?php echo e($metric['label'] ?? '-'); ?></td>
                                <td class="px-4 py-3">
                                    <?php if($entryDetailInputsHtml): ?>
                                        <div class="text-xs text-slate-700"><?php echo $entryDetailInputsHtml; ?></div>
                                    <?php else: ?>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold <?php echo e($badgeClass); ?>">
                                        <?php echo e($formatValue($metric['value'] ?? null, $decimals, $metric['unit'] ?? '')); ?>

                                    </span>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-xs text-purple-800">
                                    <?php echo e($formatLimit($limitOperator, $limitValue, $limitDecimals)); ?>
                ...
                <tbody class="divide-y divide-purple-100 text-sm text-slate-700">
                    <?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            <td class="px-4 py-3 whitespace-nowrap"><?php echo e($metric['label'] ?? '-'); ?></td>
                            <td class="px-4 py-3">
                                <?php if($detailInputsHtml): ?>
                                    <div class="text-xs text-slate-700"><?php echo $detailInputsHtml; ?></div>
                                <?php else: ?>
                                    <span class="text-xs text-slate-400">-</span>
                                <?php endif; ?>
                            </td>
...
<?php endif; ?><?php /**PATH D:\ybs\Project1YBS\resources\views/kernel/partials/success-proof-content.blade.php ENDPATH**/ ?>