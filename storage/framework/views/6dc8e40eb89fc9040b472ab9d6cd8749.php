...
<?php if($successProof): ?>
    ...
    <div class="success-proof-export-root" aria-hidden="true">
        <div id="success-proof-export" class="rounded-[28px] bg-white p-8 shadow-2xl">
            <?php echo $__env->make('kernel.partials.success-proof-content', ['successProof' => $successProof], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH D:\ybs\Project1YBS\resources\views/kernel/partials/success-proof-modal.blade.php ENDPATH**/ ?>