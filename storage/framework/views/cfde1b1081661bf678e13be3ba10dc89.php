...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Input Data Oil Losses Oil Losses']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Input Data Oil Losses Oil Losses']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Input Data Oil Losses Oil Losses']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Input Data Oil Losses Oil Losses']); ?>
        <form action="<?php echo e(route('oil.store')); ?>" method="POST" id="labForm" class="space-y-6" onsubmit="return handleFormSubmit(event, this)">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $kodeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeValue => $kodeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kodeValue); ?>" <?php echo e(old('kode') == $kodeValue ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                            <?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisValue => $jenisLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($jenisValue); ?>" <?php echo e((old('jenis', 'TBS') == $jenisValue) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <?php $__currentLoopData = $operatorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operatorName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($operatorName); ?>" <?php echo e(old('operator') == $operatorName ? 'selected' : ''); ?>>
                                            <?php echo e($operatorName); ?>

                                        </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                <p class="mt-1 text-xs text-gray-500">Daftar operator mengikuti office <?php echo e(Auth::user()->office ?? '-'); ?>.</p>
                            <?php else: ?>
                                <input type="text" name="operator" id="operator"
                                    value="<?php echo e(old('operator')); ?>" placeholder="Nama operator"
...
unset($__errorArgs, $__bag); ?>">
                                <p class="mt-1 text-xs text-gray-500">Dropdown operator belum tersedia untuk office <?php echo e(Auth::user()->office ?? '-'); ?>.</p>
                            <?php endif; ?>
                            <?php $__errorArgs = ['operator'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="sampel_boy" id="sampel_boy" 
                                ...
                                data-default-value="<?php echo e(Auth::user()->name); ?>"
                                readonly
...
unset($__errorArgs, $__bag); ?>">
                            ...
                            <?php $__currentLoopData = $kodeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeValue => $kodeName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kodeValue); ?>" <?php echo e(old('kode_mode2') == $kodeValue ? 'selected' : ''); ?>>
                                    <?php echo e($kodeName); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.000001" name="cawan_kosong" id="cawan_kosong"
                                    value="<?php echo e(old('cawan_kosong')); ?>" placeholder="0.000000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-green-500
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.000001" name="berat_basah" id="berat_basah"
                                    value="<?php echo e(old('berat_basah')); ?>" placeholder="0.000000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-green-500
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="number" step="0.000001" name="labu_kosong" id="labu_kosong"
                                    value="<?php echo e(old('labu_kosong')); ?>" placeholder="0.000000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-green-500
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.000001" name="cawan_sample_kering" id="cawan_sample_kering"
                                    value="<?php echo e(old('cawan_sample_kering')); ?>" placeholder="0.000000" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm transition focus:outline-none focus:ring-2 focus:ring-green-500
                    ...
                    <div id="finalPhaseFields">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                            <div>
                                ...
                                <input type="number" step="0.000001" name="oil_labu" id="oil_labu" value="<?php echo e(old('oil_labu')); ?>"
                ...
                <div class="mode1-row border border-blue-200 bg-white rounded-lg p-4 space-y-3">
                    ...
                    <div>
                        ...
                        <select name="mode1_rows[__INDEX__][kode]" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                            <option value="">-- Pilih Kode --</option>
                            <?php $__currentLoopData = $kodeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeValue => $kodeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kodeValue); ?>"><?php echo e($kodeLabel); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="mode1_rows[__INDEX__][jenis]" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                                <?php $__currentLoopData = $jenisOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jenisValue => $jenisLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($jenisValue); ?>" <?php echo e($jenisValue === 'TBS' ? 'selected' : ''); ?>><?php echo e($jenisLabel); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <div>
                            ...
                            <?php if(!empty($operatorOptions)): ?>
                                <select name="mode1_rows[__INDEX__][operator]" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm">
                                    <option value="">-- Pilih Operator --</option>
                                    <?php $__currentLoopData = $operatorOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $operatorName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($operatorName); ?>"><?php echo e($operatorName); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            <?php else: ?>
                ...
                <div class="mode2-row border-2 border-green-200 bg-white rounded-lg p-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select name="mode2_rows[__INDEX__][kode_mode2]" class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm select2-kode-dynamic">
                            <option value="">-- Pilih Kode --</option>
                            <?php $__currentLoopData = $kodeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeValue => $kodeName): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($kodeValue); ?>"><?php echo e($kodeName); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <p class="mt-1 text-xs text-gray-500">Format tampilan: Kode - Description. Description hanya untuk informasi.</p>
                    </div>
...
<?php endif; ?>
    ...
    <script>
        ...
        const oldMode1Rows = <?php echo json_encode(old('mode1_rows', []), 512) ?>;
        const oldMode2Rows = <?php echo json_encode(old('mode2_rows', []), 512) ?>;
...
<?php /**PATH D:\Project1YBS\resources\views/oil/create.blade.php ENDPATH**/ ?>