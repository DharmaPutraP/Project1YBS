...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.layouts.app','data' => ['title' => 'Data QWT Fibre Press']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Data QWT Fibre Press']); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['title' => 'Data QWT Fibre Press']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['title' => 'Data QWT Fibre Press']); ?>
        <div class="mb-4 md:mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create kernel losses')): ?>
                <a href="<?php echo e(route('kernel.qwt.create')); ?>"
        ...
        <div class="mb-4 md:mb-6 bg-gray-50 rounded-lg p-3 md:p-4 border border-gray-200">
            <form method="GET" action="<?php echo e(route('kernel.qwt.index')); ?>"
                    ...
                    <select name="kode" id="kode"
                        ...
                        <?php $__currentLoopData = $kodeOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kodeValue => $kodeLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($kodeValue); ?>" <?php echo e(request('kode') == $kodeValue ? 'selected' : ''); ?>>
                                <?php echo e($kodeValue); ?> - <?php echo e($kodeLabel); ?></option>
        ...
        <?php else: ?>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $kernelQwtRows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <tr class="hover:bg-blue-50">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->sampel_setelah_kuarter ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_nut_utuh ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_nut_pecah ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_kernel_utuh ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_kernel_pecah ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_cangkang ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_batu ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_fiber ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->berat_broken_nut ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->total_berat_nut ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-center">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold <?php echo e($bnTnOk === null ? 'bg-gray-100 text-gray-700' : ($bnTnOk ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800')); ?>"><?php echo e(number_format($bnTnValue, 2)); ?>%</span>
                                </td>
                                <td
                                    class="px-4 py-3 whitespace-nowrap text-center text-xs font-semibold bg-orange-50 text-orange-800">
                                    <?php if($bnTnLimitValue !== null): ?>
                                        <?php echo e($bnTnLimitOperator === 'le' ? '≤' : '>'); ?> <?php echo e(number_format($bnTnLimitValue, 2)); ?>%
                                    <?php else: ?>
                                        -
                                    <?php endif; ?>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap text-center">
                                    <span
                                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold <?php echo e($moistOk === null ? 'bg-gray-100 text-gray-700' : ($moistOk ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800')); ?>"><?php echo e(number_format($moistValue, 2)); ?>%</span>
                                </td>
                                <td
                                    class="px-4 py-3 whitespace-nowrap text-center text-xs font-semibold bg-orange-50 text-orange-800">
                                ...
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->ampere_screw ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->tekanan_hydraulic ?? 0), 2)); ?></td>
                                <td class="px-4 py-3 whitespace-nowrap text-sm text-right text-gray-900">
                                    <?php echo e(number_format((float) ($row->kecepatan_screw ?? 0), 2)); ?></td>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['edit kernel losses', 'delete kernel losses'])): ?>
                                    <td class="px-4 py-3 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit kernel losses')): ?>
                                                <a href="<?php echo e(route('kernel.qwt.edit', $row->id)); ?>"
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete kernel losses')): ?>
                                                <form action="<?php echo e(route('kernel.qwt.destroy', $row->id)); ?>" method="POST" class="delete-form" data-item-name="Data <?php echo e($row->kode ?? 'ini'); ?>">
                                                    <?php echo csrf_field(); ?>
            ...
            <div class="mt-6"><?php echo e($kernelQwtRows->links()); ?></div>
        <?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\ybs\Project1YBS\resources\views/kernel/qwt/index.blade.php ENDPATH**/ ?>