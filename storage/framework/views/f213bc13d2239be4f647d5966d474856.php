    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
        ...
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md max-h-screen overflow-y-auto">
            ...
            <div class="p-4 sm:p-6">
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST" class="space-y-4 sm:space-y-6">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\ybs\Project1YBS\resources\views\users\edit.blade.php ENDPATH**/ ?>