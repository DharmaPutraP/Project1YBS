            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-2 p-3 bg-white rounded border border-indigo-200">
                        ...
                        <div class="text-lg font-bold text-indigo-900" id="currentDateTime"><?php echo e(now()->format('d/m/Y H:i:s')); ?></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <form action="<?php echo e(route('kernel.store')); ?>" method="POST" id="kernelForm" class="space-y-6">
            ...
            <div class="border-2 border-blue-200 bg-blue-50 rounded-lg p-4">
                <label class="inline-flex items-center gap-2 text-sm font-medium text-gray-700 mb-2">
                    <input type="checkbox" name="kegiatan_dispek" id="kegiatan_dispek" value="1" <?php echo e(old('kegiatan_dispek') ? 'checked' : ''); ?> class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                ...
                <input type="time" name="rounded_time" id="rounded_time" value="<?php echo e(old('rounded_time', now()->format('H:i'))); ?>" <?php echo e(old('kegiatan_dispek') ? '' : 'disabled'); ?> class="w-full px-4 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 <?php $__errorArgs = ['rounded_time'];
                            ...
                            <div class="border rounded-lg p-4 shadow-sm space-y-3 <?php echo e($cardTheme); ?>" data-kernel-row>
                                ...
                                <div class="grid grid-cols-1 gap-3">
                                    <div>
                                        ...
                                        <select name="rows[<?php echo e($kode); ?>][jenis]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    ...
                                    <div>
                                        ...
                                        <?php if(!empty($operatorOptions)): ?>
                                            <select name="rows[<?php echo e($kode); ?>][operator]" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 <?php $__errorArgs = ["rows.$kode.operator"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <?php else: ?>
                                            <input type="text" name="rows[<?php echo e($kode); ?>][operator]" value="<?php echo e(old("rows.$kode.operator")); ?>" placeholder="Nama operator" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 <?php $__errorArgs = ["rows.$kode.operator"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <label class="inline-flex items-center gap-2 text-xs font-medium text-gray-700">
                                    <input type="checkbox" name="rows[<?php echo e($kode); ?>][pengulangan]" value="1" <?php echo e(old("rows.$kode.pengulangan") ? 'checked' : ''); ?> data-remarks-toggle class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                                ...
                                <div class="space-y-1 <?php echo e(old("rows.$kode.pengulangan") ? '' : 'hidden'); ?>" data-remarks-wrapper>
                                    ...
                                    <textarea name="rows[<?php echo e($kode); ?>][remarks]" rows="3" placeholder="Tulis catatan sampel ulang" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"><?php echo e(old("rows.$kode.remarks")); ?></textarea>
                                </div>

                                <div>
                                    <label class="block text-xs font-medium text-gray-700 mb-1">Berat Sampel (gram)</label>
                                    <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][berat_sampel]" value="<?php echo e(old("rows.$kode.berat_sampel")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 <?php $__errorArgs = ["rows.$kode.berat_sampel"];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-400 bg-red-50 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][nut_utuh_nut]" data-pair="nut-utuh-nut" data-code="<?php echo e($kode); ?>" value="<?php echo e(old("rows.$kode.nut_utuh_nut")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Nut Utuh - Kernel</label>
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][nut_utuh_kernel]" data-pair="nut-utuh-kernel" data-code="<?php echo e($kode); ?>" value="<?php echo e(old("rows.$kode.nut_utuh_kernel")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-gray-100" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][nut_pecah_nut]" data-pair="nut-pecah-nut" data-code="<?php echo e($kode); ?>" value="<?php echo e(old("rows.$kode.nut_pecah_nut")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Nut Pecah - Kernel</label>
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][nut_pecah_kernel]" data-pair="nut-pecah-kernel" data-code="<?php echo e($kode); ?>" value="<?php echo e(old("rows.$kode.nut_pecah_kernel")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm bg-gray-100" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][kernel_utuh]" value="<?php echo e(old("rows.$kode.kernel_utuh")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    </div>
                                    <div>
                                        <label class="block text-xs font-medium text-gray-700 mb-1">Kernel Pecah (gram)</label>
                                        <input type="number" step="0.0001" name="rows[<?php echo e($kode); ?>][kernel_pecah]" value="<?php echo e(old("rows.$kode.kernel_pecah")); ?>" placeholder="0.0000" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                    </div>
                                </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="flex flex-wrap justify-end gap-3 pt-6 border-t border-gray-200">
                <a href="<?php echo e(route('kernel.index')); ?>" class="px-5 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition font-medium">Batal</a>
...
<?php endif; ?>
<?php /**PATH D:\ybs\Project1YBS\resources\views/kernel/create.blade.php ENDPATH**/ ?>